...
<!--      </div>-->
      <img
        src="favicon.png"
        alt="Logo"
        class="h-32 w-32 mb-4 transition-all duration-300 hover:scale-105
      Interactive card inline-block"
      ...
      >
        ...
        with
        <span
          class="underline decoration-secondary decoration-4 md:decoration-[6px] md:text-8xl
          bg-linear-to-r from-primary to-accent mb-3 md:mb-7 pb-1
...
<!--      </div>-->
      ...
      >
        ...
        <a href="/login/sign_in">
          <button class="btn btn-outline btn-primary px-6">Log In</button
          >
        </a>
      </div>
    </div>
